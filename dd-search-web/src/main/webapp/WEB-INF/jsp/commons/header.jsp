...
<div id="header">
  <div class="header_inner">
    ...
    <div class="search">
      <form action="http://localhost:8082/ddshop/" id="searchForm" name="query" method="GET">
